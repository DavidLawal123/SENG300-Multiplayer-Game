...
public class QueueScreen_C4Controller {
    @FXML
    ...
    public void setupMatchmaking(User user, Matchmaker matchmaker, Stage stage) {
        ...
        for (User u : Database.getUsersWithStatus(UserStatus.ONLINE)) {
            if (!u.getUsername().equals(currentUser.getUsername())) {
                try {
                    matchmaker.queueForMatch(u, GameType.CONNECT_FOUR);
                } catch (Exception e) {
        ...
        try {
            ...
            matchmaker.queueForMatch(botUser, GameType.CONNECT_FOUR);
        } catch (Exception e) {
    ...
    public void handleStartGame(ActionEvent event) throws IOException {
        ...
        FXMLLoader fxmlLoader = new FXMLLoader(MainApp.class.getResource("LoadingScreenC4.fxml"));
        Scene scene = new Scene(fxmlLoader.load(), 600, 400);
        LoadingScreenC4Controller controller = fxmlLoader.getController();
