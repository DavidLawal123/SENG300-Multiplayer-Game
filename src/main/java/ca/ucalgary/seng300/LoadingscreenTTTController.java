...
//Controller for the queue screen
public class LoadingscreenTTTController {
    ...
    private void startFunFactAnimation() {
        String funtext_1 = "Your intestines are 9 meters long.";
        String funtext_2 = "The cornea is the only part of the body that receives oxygen by air.";
        String funtext_3 = "Your bones are wet and bendy.";
